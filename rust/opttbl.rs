...
pub struct LOption {
    ...
    pub ofunc: Option<unsafe fn(i32, &str)>,
...
impl Options {
    ...
    pub unsafe fn init_option_table(&mut self) {
        self.option_table = vec![
            LOption {
                oletter: 'a',
                onames: [A_OPTNAME, ""],
                otype: OptFlags::TRIPLE,
                odefault: OPT_ONPLUS,
                ovar: Some(self.how_search),
                ofunc: None,
                odesc: [
            ...
            LOption {
                ...
                otype: OptFlags::BOOL,
                odefault: OPT_OFF,
                ovar: Some(self.quit_if_one_screen),
                ofunc: None,
                odesc: [
            ...
            LOption {
                ...
                otype: OptFlags::BOOL,
                odefault: OPT_OFF,
                ovar: Some(self.opt_use_backslash),
                ofunc: None,
                odesc: [
            ...
            LOption {
                ...
                otype: OptFlags::NUMBER | OptFlags::REPAINT,
                odefault: 2,
                ovar: Some(self.status_col_width),
            ...
            LOption {
                ...
                otype: OptFlags::BOOL,
                odefault: OPT_OFF,
                ovar: Some(self.stop_on_form_feed),
                ofunc: None,
            ...
            LOption {
                ...
                otype: OptFlags::BOOL,
                odefault: OPT_OFF,
                ovar: Some(self.exit_F_on_close),
                ofunc: None,
                odesc: [
            ...
            LOption {
                ...
                otype: OptFlags::BOOL,
                odefault: OPT_OFF,
                ovar: Some(self.show_preproc_error),
                ofunc: None,
                odesc: [
...
pub unsafe fn get_options() -> &'static mut Options {
    OPTIONS.get_or_insert_with(Options::new)
}

/// Wrapper function for findopt
pub unsafe fn findopt(c: char) -> Option<*mut LOption> {
    // We need to return a raw pointer to maintain compatibility with C code
    get_options().findopt(c).map(|opt| opt as *mut LOption)
}

/// Wrapper function for findopt_name
pub unsafe fn findopt_name(optname: &str, p_oname: Option<&str>) -> (Option<*mut LOption>, bool) {
    let (opt, ambig) = get_options().findopt_name(optname, p_oname);
    (opt.map(|o| o as *mut LOption), ambig)
}
